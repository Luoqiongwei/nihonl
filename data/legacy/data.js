...
window.NihonlData = {
  ...
  songs: [
    ...
    },
    {
      ...
      lyricsStatus: "complete",
      excerpt: [
        { ja: "憧れを音に乗せて届けたい", zh: "想把憧憬寄托在声音中传达出去" },
        { ja: "叶うのなら私は愛に生きたい", zh: "如果能够实现，我想为爱而活" }
      ],
      points: [
        { ja: "〜に乗せて", zh: "寄托在…上；随着…", note: "「乗せる」的て形；歌词中表示把情感寄托在声音上并传达出去。", wordId: "ongaku" },
        { ja: "〜のなら", zh: "如果是…的话", note: "「なら」前的「の」把前句名词化，常用于基于某个前提提出愿望或判断。", wordId: "koi" }
      ],
      words: ["ongaku", "koi", "hoshi"],
      sources: [
        { label: "PetitLyrics（歌词页）", url: "https://petitlyrics.com/lyrics/3275949" },
        { label: "TuneCore Japan（专辑页）", url: "https://linkco.re/0vZTqNnM?lang=ja" }
      ]
    },
    {
      id: "terra",
